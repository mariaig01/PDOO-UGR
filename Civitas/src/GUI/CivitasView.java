...
public class CivitasView extends javax.swing.JFrame implements Vista {
    ...
    public CivitasView() {
        ...
        for(int i = 0; i < 20; ++i){ //Inicializamos el vector que serán todas las casillas del tablero.
        CasillaPanel aux = new CasillaPanel();
        casillas.add(aux);
        }
       FlowLayout layout0 = (FlowLayout)casilla0.getLayout(); //Le quitamos el padding a las casillas para que se vea su color completo.
        layout0.setVgap(0);
        ...
        casilla0.add(casillas.get(0)); //Enlazamos cada panel con las casillas del vector.
 ...
 public void actualiza() {
     ...
     //ESTO NO LO TIENE GUILLE
     //juego.getIndiceJugadorActual(); //Actualizamos el jugador.
     
     for(int i = 0; i < 20; ++i){ //Actualizamos las casillas del tablero.
        casillas.get(i).setCasilla(juego.getTablero().getCasilla(i),juego.getCasillaActual(), juego.getJugadorActual(),juego.getIndiceJugadorActual());
  ...
  public int elegirPropiedad(){
    /*  PropiedadDialog propiedad = new PropiedadDialog(this,juego.getJugadorActual());
      int iPropiedad = propiedad.getPropiedad();
